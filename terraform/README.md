...
```
curl "https://www.nubesgen.com/trocalivros.zip?iactool=TERRAFORM&region=brazilsouth&application=APP_SERVICE.free&runtime=DOCKER_SPRING&database=MYSQL.basic&addons=key_vault&gitops=true" | tar -xzvf -
```
